...
My work spans various fields including medicine (rare diseases and cancer), experimental biology, machine Learning, N-gram graphs, computational genomics, algorithm development in computational biology and next generation sequencing and has been published in peer-reviewed journals including Nature, Nucleic Acids Research, Genome Research, Bioinformatics, etc. I am also a member of the [Genomics England Research Consortium](https://public.huddle.com/a/kzWvRoL/index.html) and participate in the [BioASQ project](http://bioasq.org/).
